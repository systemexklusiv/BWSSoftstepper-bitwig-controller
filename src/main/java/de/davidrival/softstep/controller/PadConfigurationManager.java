...
public class PadConfigurationManager {
    ...
    public static class PadConfig {
        ...
        public PadConfig(PadMode mode, int min, int max, double stepSize, boolean inverted) {
            this.mode = mode;
            this.min = min;
            this.max = max;
    ...
    private void updateConfigFromSettings(int padIndex) {
        ...
        config.stepSize = parseDoubleValue(stepString, 0.1, 10.0, 1.0, "Step Size", padIndex);
